...
## Run the code
First thing first, we need to compile the code:
```bash
go build cmd/trebuchet/main.go && ./main
```
Then the program will look for `input.txt`.

If you want to use your own input, change the `input.txt` file.
