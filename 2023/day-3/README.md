...
but nobody can figure out which one. If you can add up _all the part numbers_ in
...
Of course, the actual engine schematic is much larger. _What is the sum of all of
the part numbers in the engine schematic_?
...
is wrong. A _gear_ is any `*` symbol that is adjacent to _exactly two part
